  ...
  return (
    <div className="font-sans antialiased text-brand-gray bg-white selection:bg-brand-green selection:text-white overflow-x-hidden">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-brand-green text-white p-4 rounded-full shadow-2xl hover:bg-green-600 transition-all transform hover:scale-110 hover:shadow-green-500/50 animate-bounce"
